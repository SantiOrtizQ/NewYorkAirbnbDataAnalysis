...
* **Borough Deep-Dives:** Granular reports for Manhattan, Brooklyn, Queens, the Bronx, and Staten Island, allowing for localized trend analysis.
...
* **Dataset:** 2019 New York City Airbnb open data.

## How to Use
1. Clone this repository to your local machine.
2. Ensure you have **Power BI Desktop** installed.
3. Open the `.pbix` file to interact with the full report.
